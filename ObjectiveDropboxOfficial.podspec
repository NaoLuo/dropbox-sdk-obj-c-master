Pod::Spec.new do |s|
  ...
  s.tvos.source_files = 'Source/ObjectiveDropboxOfficial/Platform/ObjectiveDropboxOfficial_tvOS/**/*.{h,m}'
...
# s.ios.public_header_files = 'Source/ObjectiveDropboxOfficial/Platform/ObjectiveDropboxOfficial_iOS/**/*.h'
  s.tvos.public_header_files = 'Source/ObjectiveDropboxOfficial/Platform/ObjectiveDropboxOfficial_tvOS/**/*.h'
...
# s.ios.frameworks = 'UIKit', 'SafariServices', 'SystemConfiguration', 'Foundation'
  s.tvos.frameworks = 'UIKit', 'SystemConfiguration', 'Foundation'
end
